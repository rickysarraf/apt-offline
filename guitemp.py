...
'''
    ...
    THIS IS TEMPORARY COMPILED UI, FROM WHICH CHANGES ARE MERGED TO
    AptOfflineGUI.py
...
#
# Created: Sun Jan 3 20:06:04 2010
...
class pyptofflineguiForm(QMainWindow):
    def __init__(self,parent = None,name = None,fl = 0):
        ...
        self.installUpdateDataRadioButton = QRadioButton(self.TabPage_2,"installUpdateDataRadioButton")
        self.installUpdateDataRadioButton.setGeometry(QRect(31,33,242,20))

        self.installUpgradeDataRadioButton = QRadioButton(self.TabPage_2,"installUpgradeDataRadioButton")
        self.installUpgradeDataRadioButton.setGeometry(QRect(31,71,242,20))

        self.installLineEdit = QLineEdit(self.TabPage_2,"installLineEdit")
        self.installLineEdit.setGeometry(QRect(31,110,330,22))

        self.textLabel7 = QLabel(self.TabPage_2,"textLabel7")
        self.textLabel7.setGeometry(QRect(30,190,171,31))

        self.installTextBrowser = QTextBrowser(self.TabPage_2,"installTextBrowser")
        self.installTextBrowser.setGeometry(QRect(28,225,331,160))

        self.instalBrowsePushButton = QPushButton(self.TabPage_2,"instalBrowsePushButton")
        self.instalBrowsePushButton.setGeometry(QRect(110,140,120,30))

        self.instalBrowseFolderPushButton = QPushButton(self.TabPage_2,"instalBrowseFolderPushButton")
        self.instalBrowseFolderPushButton.setGeometry(QRect(240,140,121,31))
    ...
    def languageChange(self):
        ...
        self.instalBrowsePushButton.setText(self.__tr("from Archive"))
        self.instalBrowseFolderPushButton.setText(self.__tr("from Folder"))
