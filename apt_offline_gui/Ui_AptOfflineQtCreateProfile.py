...
class Ui_CreateProfile(object):
    def setupUi(self, CreateProfile):
        ...
        self.comboBox = QtGui.QComboBox(CreateProfile)
        self.comboBox.setGeometry(QtCore.QRect(164, 276, 110, 30))
        self.comboBox.setObjectName(_fromUtf8("comboBox"))
        self.comboBox.addItem(_fromUtf8(""))
        self.comboBox.addItem(_fromUtf8(""))
        self.comboBox.addItem(_fromUtf8(""))
        self.comboBox_2 = QtGui.QComboBox(CreateProfile)
        self.comboBox_2.setEnabled(False)
        self.comboBox_2.setGeometry(QtCore.QRect(330, 276, 100, 30))
    ...
    def retranslateUi(self, CreateProfile):
        ...
        self.comboBox.setToolTip(_translate("CreateProfile", "Choose APT backend. Default backend is the most tested and known to work under all scenarios", None))
        self.comboBox.setItemText(0, _translate("CreateProfile", "apt-get", None))
        self.comboBox.setItemText(1, _translate("CreateProfile", "apt", None))
        self.comboBox.setItemText(2, _translate("CreateProfile", "python-apt", None))
        self.comboBox_2.setToolTip(_translate("CreateProfile", "Choose upgrade type to perform", None))
        self.comboBox_2.setItemText(0, _translate("CreateProfile", "upgrade", None))
        self.comboBox_2.setItemText(1, _translate("CreateProfile", "dist-upgrade", None))
        self.comboBox_2.setItemText(2, _translate("CreateProfile", "dselect-upgrade", None))
