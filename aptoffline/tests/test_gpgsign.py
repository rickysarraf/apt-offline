...
class TestVerifySignature (unittest.TestCase):
    ...
    def test_detached_sign_verify(self):
        v = verifysig.VerifySignature(resource_path('signverify/keyring/debian-archive-jessie-automatic.gpg'))
        self.assertTrue(v.detached_sign_verify(resource_path('signverify/signature.gpg'),
